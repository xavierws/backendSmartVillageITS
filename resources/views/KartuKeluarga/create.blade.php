...
<head>
   ...
   <title>Input Kartu Keluarga</title>
</head>
<body>
   <div class="container">
      <br>
      ...
      <div class="row"> 
         <div class="col-md-3">
            <form method="POST" action="{{url('data/KartuKeluarga')}}">
            {{csrf_field()}}
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="kepalaKeluarga">
               </div>
               <div class="form-group">
            ...
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>{{$data['kota']}}</td>
                     <td>{{$data['provinsi']}}</td>
                     <td><a href="{{action('ShowKartuKeluarga@edit', $data['id'])}}" class="btn btn-primary btn-block">Edit</a></td>
                     <td>
                        <form action="{{action('ShowKartuKeluarga@destroy', $data['id'])}}" method="post">
                            {{csrf_field()}}
