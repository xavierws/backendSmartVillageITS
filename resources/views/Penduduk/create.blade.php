...
<body>
   <div class="container">
      ...
      <div class="row"> 
         <div class="col-md-3">
            <form method="POST" action="{{url('data/Penduduk')}}">
            {{csrf_field()}}
               ...
               <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="kartu_keluarga_id">
               </div>
            ...
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>{{$data['kartu_keluarga_id']}}</td>
                     <td><a href="{{action('ShowPenduduk@edit', $data['id'])}}" class="btn btn-primary btn-block">Edit</a></td>
                     <td>
                        <form action="{{action('ShowPenduduk@destroy', $data['id'])}}" method="post">
                            {{csrf_field()}}
