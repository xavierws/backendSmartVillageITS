...
<head>
   ...
   <title>Input Surat Miskin</title>
</head>
<body>
   <div class="container">
      <br>
      ...
      <div class="row"> 
         <div class="col-md-4">
            <form method="POST" action="{{url('data/SuratMiskin')}}">
            {{csrf_field()}}
            ...
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><a href="{{action('ShowSuratMiskin@edit', $data['id'])}}" class="btn btn-primary btn-block">Edit</a></td>
                     <td>
                        <form action="{{action('ShowSuratMiskin@destroy', $data['id'])}}" method="post">
                            {{csrf_field()}}
