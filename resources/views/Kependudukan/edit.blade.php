...
<body>
    <div class="container">
        ...
        <form method="post" action="{{action('ShowKependudukan@update', $id)}}">
            {{csrf_field()}}
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="hubungan" value="{{$data->hubungan}}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" name="pelapor_id" value="{{$data->pelapor_id}}">
                </div>
            </div>
