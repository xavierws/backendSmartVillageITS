...
<head>
   ...
   <title>Ubah Surat Kematian</title>
</head>
<body>
    <div class="container">
        <div class="row">
        ...
        <form method="post" action="{{action('ShowSuratKematian@update', $id)}}">
            {{csrf_field()}}
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" name="terlapor_id" value="{{$data->terlapor_id}}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"></div>
